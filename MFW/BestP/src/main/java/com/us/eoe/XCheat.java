...
public class XCheat implements IXposedHookLoadPackage {
    private static String TAG = "XCheat";
...
//        });
        ...
        if (!lpp.packageName.equals("com.us.eoe")) {
            return;
        }
...
//                    currentMis = System.currentTimeMillis();
//                    ++location;
//                    if (location >= list.sizegetDeviceInfo())
//                        location = 0;
...
//    }
    ...
    private void getDeviceInfo() {
        ...
        if (cursor == null) {
            XposedBridge.log("cursor is null  cursor return");
            return;
        }
